...
export default class Dropdown extends PureComponent {
  ...
  renderBase(props) {
    ...
    return <TextField {...props} value={title} editable={false} onChangeText={undefined}
  ...
  renderRipple() {
    ...
    return <Ripple style={style} rippleColor={baseColor} rippleDuration={animationDuration * 2}
                   rippleOpacity={rippleOpacity} rippleCentered={rippleCentered} rippleSequential={rippleSequential}
            ...
            <TouchableWithoutFeedback onPress={this.onClose}>
              <View style={overlayStyle}>
                <Animated.View style={[styles.picker, pickerStyle, pickerStyleOverrides]}>
                  <ScrollView ref={this.updateScrollRef} style={styles.scroll}
